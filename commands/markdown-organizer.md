...
2. 执行脚本美化文档：`python3 ~/LLM/claude_code/organize_markdown_skills/scripts/organize_markdown.py {file_path} [base_url]`
3. 执行脚本增强内容：`python3 ~/LLM/claude_code/organize_markdown_skills/scripts/enhance_content.py --enhance {file_path}`
