...
### 改进
- 🔄 **架构重构**：从脚本驱动改为 Claude 步骤驱动模型，提高内容生成质量
- 📊 **知识图谱**：新增 Mermaid 图谱展示文档核心概念及其关系
- 🎯 **5 步工作流**：分析 → 生成内容 → 插入文档 → 处理图片 → 验证保存
- 🔧 **YAML 修复**：完善 frontmatter 插入位置处理
- ✨ **内容增强**：摘要、学习目标、前置知识、知识图谱、FAQ 五大板块
